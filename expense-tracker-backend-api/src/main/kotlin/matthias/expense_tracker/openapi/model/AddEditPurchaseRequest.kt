 ...
 * @param products
 */
data class AddEditPurchaseRequest(

    @Schema(example = "4a807620-7e35-4824-bbe9-acf4a597c97f", required = true, description = "")
    @field:JsonProperty("shopId", required = true) val shopId: java.util.UUID,
    ...
    @field:JsonProperty("products", required = true) val products: kotlin.collections.List<AddEditProductRequest>
) {
